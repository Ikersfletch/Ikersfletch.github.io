...
function draw() {
  ...
  text("Due to the way .json files work, some of the years shown here are too precise to be trusted.",width - textWidth("Due to the way .json files work, some of the years shown here are to precise to be trusted.")-5, height-20);
  pop();
